...
#PBS -m ae
#PBS -M irelandb99999@gmail.com

### Optionally set the destination for your program's output
### Specify localhost and an NFS filesystem to prevent file copy errors.
#PBS -e localhost:$HOME/billjob1.err
#PBS -o localhost:$HOME/billjob1.log
...
$HOME/sortseq/MCMC/fullthermo/runsim.py $runnum $savefn
# The submit syntax is qsub -v runnum=$runnum,savefn=$savefn pbs-thermo.sh
